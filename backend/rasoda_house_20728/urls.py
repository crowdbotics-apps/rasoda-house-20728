"""rasoda_house_20728 URL Configuration
...
admin.site.site_header = "Rasoda House"
admin.site.site_title = "Rasoda House Admin Portal"
admin.site.index_title = "Rasoda House Admin"

# swagger
api_info = openapi.Info(
    title="Rasoda House API",
    default_version="v1",
    description="API documentation for Rasoda House App",
)
